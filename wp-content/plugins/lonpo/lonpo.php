...
/*
Plugin Name: Lonpo
Description: Un truc d'ODC
Version: 1.0
Author: Ibrahim B Diakitre
*/
    ...
    function html_form_code(){
        ...
        echo '<p>';
        echo '<label for="cf-email" style="color: #06668E; font-weight: bold;">Votre Email</label> <br />';
        ...
        echo '</p>';
        echo '<p>';
        echo '<label for="cf-name" style="color: #06668E; font-weight: bold;">Votre Nom </label> <br />';
    ...
    function deliver_mail() {
        ...
        if ( isset( $_POST['cf-submitted'] ) ) {
            ...
            try {
                ...
                $mail->Username   = 'pablopicasso698@gmail.com';                     //SMTP username
                $mail->Password   = 'ctlbtxxijewuvepm';                               //SMTP password
                ...
                //Recipients
                $mail->setFrom('pablopicasso698@gmail.com','Exo vite');
                $mail->addAddress('diakiteibrahimblonkon@gmail.com');     //Add a recipient
        
                $headers = "From: $name <$email>" . "\r\n";

                $mail->addReplyTo($email, $name);
                $mail->Subject = 'Contact Exovite';
                $mail->isHTML(false);
                $mail->Body = <<<EOT
                E-mail: $email
                Nom: $name
                ...
                if (!$mail->send()) {
                    ...
                    echo 'Exovite vous remercie de votre interet';
                }
    ...
    add_shortcode('lonpo_form', 'lonpo_form_shortcode');
?>